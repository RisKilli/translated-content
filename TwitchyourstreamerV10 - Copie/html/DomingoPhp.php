...
if(!$mysqli) exit('Connexion MySQL non accomplie!');
 ...
 //  Vérifiez si l'utilisateur est connecté, sinon redirigez-le vers la page de connexion
  ...
  // exit quitte met une page blanche !   
  }
...
<div class="streamcom">
     ...
     <iframe id="streamcom1"src="https://player.twitch.tv/?channel=DOMINGO&parent=localhost" height="700px" width="90%" preload> <!-- it's work !!!! -->
        
     </iframe>
     </div>
  <div class="commentaire">
    <div class="centrecommentaire">
     <h1>Tu penses quoi de Domingo ?</h1>
