...
<div class="streamcom">
     ...
     <iframe id="streamcom1"src="https://player.twitch.tv/?channel=ZERATOR&parent=geraldsaintpierre.sites.3wa.io" height="700px" width="90%" preload> <!-- it's work !!!! -->
        
     </iframe>
     </div>
  <div class="commentaire">
    <div class="centrecommentaire">
     <h1>Tu pense quoi de Zerator ?</h1>
