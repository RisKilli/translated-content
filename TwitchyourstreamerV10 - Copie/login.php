...
<div class="div1" >
 ...
 <div id="container">
            ...
            <div class=""> 
              <div>
                <input class="inputlogin" type="text" placeholder="Entrer le nom d'utilisateur" name="username" pattern="[a-zA-Z@1-9]{4,15}" title="Les caractères speciaux ne sont pas autorisé" required>
              </div>
              <div>
<input class="inputlogin" type="password" placeholder="Entrer le mot de passe" name="password" id='password' pattern="[a-zA-Z@1-9]{4,15}" title="Les caractères speciaux ne sont pas autorisé"  required>
                ...
                <em class="">
                  <div>
                    <a href="register.php" class="ColorC">Crée un compte ?</a>
                  </div>
                    <a href="index.php" class="ColorC">Ne pas crée de compte ?</a>
                </em>
